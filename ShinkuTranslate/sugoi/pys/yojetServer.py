...
def runService(host, port, gpu, silent):
    ...
    ja2en = TransformerModel.from_pretrained(
        '../models/sugoi-fairseq-4/japaneseModel/',
        checkpoint_file='big.pretrain.pt',
        source_lang = "ja",
        target_lang = "en",
        bpe='sentencepiece',
        sentencepiece_model='../models/sugoi-fairseq-4/sp_model/spm.ja.nopretok.model',
    ...
    def processTranslation():
        ...
        finalResult = finalResult.replace("<unk>"," ")
